...
class FileUploader extends Editor {
    ...
    _getDocumentScrollTop() {
        ...
        var isScrollBodyIE = browser.msie && "hidden" === window.getComputedStyle(document.body).overflow && document.body.scrollTop > 0;
        if (isScrollBodyIE) {
    ...
    _getDocumentScrollLeft() {
        var document = domAdapter.getDocument();
        var isScrollBodyIE = browser.msie && "hidden" === window.getComputedStyle(document.body).overflow && document.body.scrollLeft > 0;
        if (isScrollBodyIE) {
