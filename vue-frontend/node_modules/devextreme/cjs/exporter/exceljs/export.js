...
var Export = {
    ...
    export: function(options, helpers) {
        ...
        var initialLoadPanelEnabledOption = component.option("loadPanel") && component.option("loadPanel").enabled;
        ...
        return new Promise((function(resolve) {
            dataProvider.ready().done((function() {
                ...
                for (var rowIndex = 0; rowIndex < dataRowsCount; rowIndex++) {
                    ...
                    _this2.exportRow(dataProvider, helpers, mergedRangesManager, rowIndex, columns.length, row, cellRange.from.column, customizeCell, wrapText, styles, encodeExecutableContent);
                    if (rowIndex >= 1) {
                        cellRange.to.row++
                    }
                }
    ...
    exportRow: function(dataProvider, helpers, mergedRangesManager, rowIndex, cellCount, row, startColumnIndex, customizeCell, wrapText, styles, encodeExecutableContent) {
