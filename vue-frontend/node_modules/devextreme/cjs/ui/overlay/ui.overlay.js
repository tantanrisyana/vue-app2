...
var Overlay = _ui.default.inherit({
    ...
    _show: function() {
        ...
        if (this._isHidingActionCanceled) {
            ...
            var show = function() {
                _this10._stopAnimation();
                _this10._toggleVisibility(true);
                _this10._$content.css("visibility", "hidden");
                _this10._$content.toggleClass(INVISIBLE_STATE_CLASS, false);
                _this10._updateZIndexStackPosition(true);
                _this10._positionController.openingHandled();
                _this10._renderContent();
                var showingArgs = {
                    cancel: false
                };
                _this10._actions.onShowing(showingArgs);
                if (showingArgs.cancel) {
                    ! function() {
                        _this10._toggleVisibility(false);
                        _this10._$content.css("visibility", "");
                        _this10._$content.toggleClass(INVISIBLE_STATE_CLASS, true);
                        _this10._isShowingActionCanceled = true;
                        _this10._moveFromContainer();
                        _this10.option("visible", false);
    ...
    _hide: function() {
        ...
        if (this._isShowingActionCanceled) {
            ...
            if (hidingArgs.cancel) {
                ! function() {
                    _this12._isHidingActionCanceled = true;
                    _this12.option("visible", true);
                    _this12._hidingDeferred.resolve()
                }()
            } else {
                ! function() {
                    _this12._forceFocusLost();
                    _this12._toggleShading(false);
                    _this12._toggleSubscriptions(false);
                    _this12._stopShowTimer();
                    _this12._animateHiding()
                }()
            }
        }
    ...
    _initTabTerminatorHandler: function() {
        ...
        this._proxiedTabTerminatorHandler = function() {
            _this13._tabKeyHandler.apply(_this13, arguments)
        }
    },
    ...
    _renderContentImpl: function() {
        ...
        contentTemplate && contentTemplate.render({
            ...
            onRendered: function() {
                ...
                if (_this14.option("templatesRenderAsynchronously")) {
                    _this14._dimensionChanged()
                }
            }
        });
        this._renderDrag();
        ...
        whenContentRendered.done((function() {
            if (_this14.option("visible")) {
                _this14._moveToContainer()
            }
        }));
    ...
    _optionChanged: function(args) {
        var _this$_resizable, _this17 = this;
