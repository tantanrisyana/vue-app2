...
var Overlay = _ui.default.inherit({
    ...
    _renderResize: function() {
        ...
        this._resizable = this._createComponent(this._$content, _resizable.default, {
            ...
            onResizeEnd: function(e) {
                _this6._resizeEndHandler(e)
            },
            onResize: function(e) {
                _this6._actions.onResize(e)
            },
            onResizeStart: function(e) {
                _this6._actions.onResizeStart(e)
            },
            minHeight: 100,
            minWidth: 100,
    ...
    _attachKeyboardEvents: function() {
        ...
        this._keyboardListenerId = _short.keyboard.on(this._$content, null, (function(opts) {
            return _this7._keyboardHandler(opts)
        }))
    },
        ...
        switch (args.name) {
            ...
            case "visible":
                this._renderVisibilityAnimate(value).done((function() {
                    if (!_this8._animateDeferred) {
                        return
                    }
                    _this8._animateDeferred.resolveWith(_this8)
                }));
                break;
            case "target":
    ...
    toggle: function(showing) {
        ...
        animateDeferred.promise().done((function() {
            delete _this9._animateDeferred;
            result.resolveWith(_this9, [_this9.option("visible")])
        }));
