...
var FileUploader = function(_Editor) {
    ...
    _proto._getDropZoneElement = function(isCustomTarget, e) {
        var targetList = [];
        if (isCustomTarget) {
            (0, _renderer.default)(this.option("dropZone")).each((function(i, element) {
                return targetList.push((0, _renderer.default)(element).get(0))
            }))
        } else {
    ...
    _proto._getDocumentScrollTop = function() {
        ...
        var isScrollBodyIE = _browser.default.msie && "hidden" === window.getComputedStyle(document.body).overflow && document.body.scrollTop > 0;
        if (isScrollBodyIE) {
    ...
    _proto._getDocumentScrollLeft = function() {
        var document = _dom_adapter.default.getDocument();
        var isScrollBodyIE = _browser.default.msie && "hidden" === window.getComputedStyle(document.body).overflow && document.body.scrollLeft > 0;
        if (isScrollBodyIE) {
