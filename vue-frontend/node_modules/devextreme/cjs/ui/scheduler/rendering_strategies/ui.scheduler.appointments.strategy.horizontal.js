...
var HorizontalRenderingStrategy = function(_BaseAppointmentsStra) {
    ...
    _proto.calculateAppointmentWidth = function(appointment, position) {
        ...
        var _position$info$appoin = position.info.appointment,
            startDate = _position$info$appoin.startDate,
            endDate = _position$info$appoin.endDate;
        var normalizedEndDate = this.normalizeEndDateByViewEnd(appointment, endDate);
