...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto2._dateTableScrollableConfig = function() {
        ...
        var config = {
            ...
            onScroll: function() {
                ...
                null === (_this$_groupedStrateg = _this._groupedStrategy.cache) || void 0 === _this$_groupedStrateg ? void 0 : _this$_groupedStrateg.clear()
            }
        };
    ...
    _proto2._createCrossScrollingConfig = function(currentConfig) {
        var _this2 = this;
        var config = {};
        ...
        config.onScroll = function(e) {
            currentOnScroll();
            _this2._dataTableSemaphore.take();
            _this2._sideBarSemaphore.isFree() && _this2._sidebarScrollable && _this2._sidebarScrollable.scrollTo({
                top: e.scrollOffset.top
            });
            _this2._headerSemaphore.isFree() && _this2._headerScrollable && _this2._headerScrollable.scrollTo({
                left: e.scrollOffset.left
            });
            _this2._dataTableSemaphore.release()
        };
        config.onEnd = function() {
            _this2.notifyObserver("updateResizableArea", {})
        };
        return config
    };
    ...
    _proto2._setSelectedCellsByCellData = function(data) {
        ...
        data.forEach((function(cellData) {
            ...
            if (!groupIndex) {
                groupIndex = _this5._isGroupsSpecified(groups) ? _this5._getGroupIndexByResourceId(groups) : 0
            }
            var coordinates = _this5.isVirtualScrolling() ? _this5.viewDataProvider.findCellPositionInMap({
                groupIndex: groupIndex,
                startDate: startDate,
                isAllDay: allDay,
                index: index
            }) : _this5.getCoordinatesByDate(startDate, groupIndex, allDay);
            if (coordinates) {
                ...
                if ((0, _type.isDefined)($cell)) {
                    _this5._toggleFocusClass(true, (0, _renderer.default)($cell));
                    cells.push($cell)
                }
            }
        }));
    ...
    _proto2._getAllGroups = function() {
        ...
        return _toConsumableArray(new Array(groupCount)).map((function(_, groupIndex) {
            var groupsArray = _this9._getCellGroups(groupIndex);
    ...
    _proto2._attachDragEvents = function(element) {
        ...
        _events_engine.default.on(element, DragEventNames.ENTER, DRAG_AND_DROP_SELECTOR, {
            ...
            if (!_this10.preventDefaultDragging) {
        ...
        _events_engine.default.on(element, DragEventNames.DROP, DRAG_AND_DROP_SELECTOR, (function() {
            var _this10$dragBehavior, _this10$dragBehavior$;
            if (!(null !== (_this10$dragBehavior = _this10.dragBehavior) && void 0 !== _this10$dragBehavior && _this10$dragBehavior.dragBetweenComponentsPromise)) {
                _this10.dragBehavior.removeDroppableClasses();
                return
            }
            null === (_this10$dragBehavior$ = _this10.dragBehavior.dragBetweenComponentsPromise) || void 0 === _this10$dragBehavior$ ? void 0 : _this10$dragBehavior$.then((function() {
                _this10.dragBehavior.removeDroppableClasses()
            }))
        }))
    };
    ...
    _proto2._getWorkSpaceWidth = function() {
        ...
        return this.cache.get("workspaceWidth", (function() {
            ...
            var totalWidth = (0, _position.getBoundingRect)(_this12.$element().get(0)).width;
            var timePanelWidth = _this12.getTimePanelWidth();
            var groupTableWidth = _this12.getGroupTableWidth();
    ...
    _proto2.getRMaxAllowedHorizontalPosition = function(groupIndex) {
        ...
        if (!this._maxAllowedPosition[groupIndex]) {
            ...
            ! function(cellIndex) {
                var cell = _this16._$dateTable.find("tr:not(.".concat(VIRTUAL_ROW_CLASS, ")")).first().find("td:not(.".concat(_constants.VIRTUAL_CELL_CLASS, ")")).get(cellIndex);
                var maxPosition = (0, _renderer.default)(cell).position().left;
    ...
    _proto2.getMaxAllowedVerticalPositionStandard = function(groupIndex) {
        ...
        if (0 === this._maxAllowedVerticalPosition.length) {
            ...
            this._$dateTable.find("tr:not(.".concat(VIRTUAL_ROW_CLASS, "):nth-child(").concat(rowCount, "n)")).each((function(_, row) {
                ...
                _this17._maxAllowedVerticalPosition.push(Math.round(maxPosition))
            }))
        }
    ...
    _proto2.getRMaxAllowedVerticalPosition = function(groupIndex) {
        ...
        if (!this._maxAllowedVerticalPosition[groupIndex]) {
            ...
            ! function(rowIndex) {
                var row = _this18._$dateTable.find("tr:not(.".concat(VIRTUAL_ROW_CLASS, ")")).get(rowIndex);
                var maxPosition = (0, _renderer.default)(row).position().top + (0, _position.getBoundingRect)(row).height;
                if (_this18.isGroupedAllDayPanel()) {
                    maxPosition -= (groupIndex + 1) * _this18.getAllDayHeight()
                }
                _this18._maxAllowedVerticalPosition[groupIndex] = Math.round(maxPosition)
            }(rowIndex)
        }
        return this._maxAllowedVerticalPosition[groupIndex]
    };
    ...
    _proto2.getCellDataByCoordinates = function(coordinates, allDay) {
        ...
        return this.cache.get(key, (function() {
            var $cells = _this19._getCells(allDay);
            var cellIndex = _this19.getCellIndexByCoordinates(coordinates, allDay);
            var $cell = $cells.eq(cellIndex);
            return _this19.getCellData($cell)
        }))
    };
    ...
    _proto2.needUpdateScrollPosition = function(date, groups, inAllDayRow) {
        ...
        return cells.reduce((function(currentResult, cell) {
            var _this20$getCellData = _this20.getCellData(cell),
                cellStartDate = _this20$getCellData.startDate,
                cellEndDate = _this20$getCellData.endDate,
                cellGroupIndex = _this20$getCellData.groupIndex;
    ...
    _proto2._createDragBehaviorBase = function($element, options) {
        ...
        this.dragBehavior.addTo($element, createDragBehaviorConfig(container, this.isDefaultDraggingMode, this.dragBehavior, (function() {
            if (!_this21.isDefaultDraggingMode) {
                _this21.preventDefaultDragging = false
            }
        }), (function() {
            if (!_this21.isDefaultDraggingMode) {
                _this21.preventDefaultDragging = true
            }
        }), (function() {
            return _this21._getDroppableCell()
        }), (function() {
            return _this21._getDateTables()
        }), (function() {
            return _this21.removeDroppableCellClass()
        }), (function() {
            return _this21.getCellWidth()
        }), options))
    };
