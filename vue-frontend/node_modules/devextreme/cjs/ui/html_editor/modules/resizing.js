...
var ResizingModule = function(_BaseModule) {
    ...
    _proto._clickHandler = function(e) {
        if (this._isAllowedTarget(e.target)) {
            ...
            var minWidth = Math.max($target.outerWidth() - $target.width(), this.resizable.option("minWidth"));
            var minHeight = Math.max($target.outerHeight() - $target.height(), this.resizable.option("minHeight"));
