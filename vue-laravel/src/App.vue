<template>
  <div class="container">
    ...
    >
      ...
      <DxColumn data-field="nama" caption="Nama" />
      <DxColumn data-field="umur" caption="Umur" />
...
const url = "http://localhost:8000/api/v1/siswa";
...
const dataSource = {
  ...
  update: async (key, values) => {
    try {
      await axios.patch(`${url}/${key}`, values); // Mengirimkan data perubahan ke endpoint patch
      await dataSource.load(); // Memuat ulang data setelah berhasil mengupdate
    } catch (error) {
